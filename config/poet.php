...
return [
    ...
    */
    ...
    'post' => [
        'project'=>[
            'enter_title_here'=> __('Project Title','khawar'),
            'menu_icon'=> 'dashicons-welcome-widgets-menus',
            'supports'=>['title','editor','author', 'price','revisions','thumbnail','taxonomy'],
            'show_in_rest'=> true,
            'has_archive'=> true,
            'rewrite'=> [
                'slug'=>'projects'
            ...
            'labels'=> [
                'singular'=>__("Project","khawar"),
                'plural'=> __('Projects','khawar'),
            ],
        ],
        'testimonial'=>[
            'enter_title_here'=>__('Testimonial Title','khawar'),
            ...
            'labels'=> [
                'singular'=>__("Testimonial","khawar"),
                'plural'=> __('Testimonials','khawar'),
            ],
        ]
    ],
