<div class="container mx-auto  border-border/50">
    <form id="contactForm" method="POST" class="w-full space-y-6 mx-auto border border-dashed-subtle-default p-6">
        ...
        <div class="mb-6">
            <h2
                class="font-display {{ !empty($items['header_alignment']) && $items['header_alignment'] == 1 ? 'text-center' : 'text-left' }} text-2xl md:text-3xl font-bold mb-4">
            ...
            <p
                ...
                Let’s discuss how I can provide the right solution for you.
            </p>
        </div>
        ...
        <div id="captchaMessageContainer">
            ...
            @endif
            <div id="formMessage" class="hidden font-display text-sm p-3 border-dashed-subtle-default">
            </div>
        </div>
